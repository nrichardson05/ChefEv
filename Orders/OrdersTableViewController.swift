...
//  ChefEV
//
//  Created by Nick Richardson on 10/1/17.
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if (segue.identifier == "showDetailView") {
            ...
            let DVC2 = segue.destination as! OrderDetailTableViewController
            
            if let indexpath = self.tableView.indexPathForSelectedRow {
                
                let proteins = titleList[indexpath.row] as String
                result.append(proteins)
                DVC2.sentData2 = result
                DVC.sentData1 = proteins
                print("this is your results array: ", result)
            }
